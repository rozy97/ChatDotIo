...
class ProfileScreen extends Component {
  ...
  UNSAFE_componentWillMount = async () => {
    await AsyncStorage.getItem('uid').then(async uid => {
      firebase
        .database()
        .ref('users/' + uid)
        .on('value', value => {
      ...
      <View style={styles.container}>
        ...
        <ScrollView style={styles.body}>
          <TouchableOpacity
            ...
            <Text style={{paddingLeft: 9, color: '#0086ad'}}>
              {user.fullname}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Text style={{paddingLeft: 9, color: '#0086ad'}}>N/A</Text>
          </TouchableOpacity>
