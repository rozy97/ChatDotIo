    ...
    if (item.uid != this.state.uid) {
      return (
        <TouchableOpacity
          ...
          onPress={() =>
            this.props.navigation.navigate('FriendProfile', {item: item})
          }
          activeOpacity={0.5}>
          ...
          <View style={{paddingLeft: 10, paddingTop: 6}}>
            ...
            <View>
              <Text style={{color: '#ffffff40', fontSize: 12}}>
                {item.statusmessage}
              </Text>
            </View>
          </View>
      ...
      <SafeAreaView style={styles.container}>
        <View
          ...
          <Text
            ...
            Friends {this.state.users.length - 1}
          </Text>
        </View>
        <ScrollView>
          <TouchableOpacity
          ...
          <TouchableOpacity
            activeOpacity={1}
            onPress={() => {
              this.setState({friendDropdown: !this.state.friendDropdown});
            }}>
            <View
              style={{
                height: 27,
              ...
              <Text style={{fontSize: 15, color: 'grey', paddingLeft: 12}}>
                Friends {this.state.users.length - 1}
              </Text>
              {!this.state.friendDropdown ? (
                <Icon
                  type="Ionicons"
                  name="ios-arrow-down"
                  style={{color: 'grey', fontSize: 18, paddingRight: 11}}
                />
              ) : (
                <Icon
                  type="Ionicons"
